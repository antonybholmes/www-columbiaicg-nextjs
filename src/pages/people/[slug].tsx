...
import { getPostBySlug, getAllPosts, getPersonBySlug, getAllPeople } from '../../lib/api'
        ...
        {router.isFallback ? (
          ...
          <>
            <article className="mb-32">
              <Head>
                <title>
                  {person.fields.firstName} | Next.js Blog Example with {CMS_NAME}
                </title>
                
              </Head>
              <h1>{person.fields.firstName} {person.fields.lastName}</h1>
